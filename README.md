...
1. **Clone The Repositories:**
   ```bash
   git clone https://github.com/vonssy/T1-BOT.git
   ```
   ```bash
   cd T1-BOT
   ```
...
### Note: Check your web3, eth-utils, eth-abi and eth-account libraries version first. If not same with version in requirements.txt, u must uninstall that library.
